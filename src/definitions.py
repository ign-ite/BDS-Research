class VM:
    def __init__(self, vm_id, cpu, mem, price):
        ...
        self.mem_now = mem
        self.price = price
        # Keep explicit base/current prices for stochastic pricing experiments.
...
class JOB:
    def __init__(self, arrival_time, j_id, j_type, cpu, mem, ex, duration):
        ...
        self.running = False
        self.finished = False
        self.deadline = self.arrival_time + self.duration * 1.5  # Set default deadline to 1.5 times the duration
